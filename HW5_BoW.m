...
% Last modified: 16-Oct-2018    
    ...
    methods (Static)
        function main()
            ...
            [trIds, trLbs] = ml_load('D:/Subjects/ML/hw5data/bigbangtheory_v3/train.mat',  'imIds', 'lbs');             
            tstIds = ml_load('D:/Subjects/ML/hw5data/bigbangtheory_v3/test.mat', 'imIds'); 
        ...
        function bowCs = learnDictionary(scales, normH, normW)
            ...
            % load train ids
            trIds = ml_load('D:/Subjects/ML/hw5data/bigbangtheory_v3//train.mat', 'imIds'); 
            ...
            for i=1:length(trIds)
                ...
                im = imread(sprintf('D:/Subjects/ML/hw5data/bigbangtheory_v3//%06d.jpg', trIds(i)));
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            k=1000;
            [~,bowCs,~,~] = kmeansbow(randWins',k);
            bowCs=bowCs';
            %save('KmeansCentroids.mat', 'bowCs');
        end
        ...
        function D = cmpFeatVecs(imIds, scales, normH, normW, bowCs)
            ...
            for i=1:n
                ...
                im = imread(sprintf('D:/Subjects/ML/hw5data/bigbangtheory_v3//%06d.jpg', imIds(i)));                                
